...
function Meteo() {
    ...
    const getWeather = (event) => {
        if (event.key === "Enter") {
            fetch(`https://api.openweathermap.org/data/2.5/weather?q=${city}&units=imperial&lang=fr&APPID=${apiKey}`).then(
                                ...
                                typeof weatherData.main === "undefined" ? (
                                    ...
                                    <>
                                        <div style={{
                                            ...
                                            <p className="temp"><i className="fas fa-thermometer-half fa-1x"> </i> {Math.round(((weatherData.main.temp) - 32) * 5 / 9)} °C</p>
                                            <p><i className="fa fa-tint"> </i> {weatherData.main.humidity} %</p>
